                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="To">Product Code</label>
...
<script>
    $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('warehouse.consolidate.getConsolidateList') }}',
                    data: function(d) {
            ...
            $('.livesearch').select2({
                ...
                width: '100%',
                ajax: {
                    url: '{{ route('warehouse.consolidate.getConsolidateListSearch') }}',
                    dataType: 'json',
                    delay: 250,
            ...
            $(document).on('click', '.exportToExcel1', function(e) {
                $("#product_table").table2excel({
                    exclude: ".noExl",
                    name: "consolidate",
                    filename: "consolidate-" + today + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
