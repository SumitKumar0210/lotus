...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Purchase Branch</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Purchase</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Purchase Branch</li>
                </ol>
            </div>
            <div class="btn btn-list">
                <a class="btn ripple btn-primary exportToExcel" href="{{ route('branch.dashboard') }}"><i
                        class="fe fe-external-link"></i> Go Back</a>
            </div>
        </div>
        <!-- End Page Header -->
        <form action="{{ route('branch-purchase.store') }}" method="POST" enctype="multipart/form-data" id="submit_form">
            @method('POST')
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <input name="from_warehouse_id" id="from_warehouse_id" type="hidden"
                            value="{{ $warehouse_detail->branch_id }}">
                    </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#product_code_choose', function() {
                ...
                if (product_code_choose !== '') {
                    ...
                    let url =
                        "{{ route('branch.purchase.getBranchTransferProductDetail', ':product_code_choose') }}";
            ...
            $(document).on('submit', '#submit_form', function(e) {
                ...
                if (from_warehouse_id === '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('branch-purchase.store') }}",
