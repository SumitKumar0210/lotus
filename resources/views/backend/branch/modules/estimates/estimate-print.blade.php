       ...
       left: 0;">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td class="valign-middle" colspan="2" rowspan="9">
                        <div class="invoice-notes">
                            ...
                            @if (!empty($estimate->remarks))
                                <label class="main-content-label tx-10">Remarks:</label>
                                <p class="tx-9-f">{{ $estimate->remarks }}</p>
                            @endif
                        </div><!-- invoice-notes -->
                    </td>
                    <td>Sub Total</td>
                ...
                @if ($estimate->discount_value != 0 || $estimate->discount_value != '')
                    <tr>
                        <td>Discount</td>
                ...
                @if ($estimate->freight_charge != 0 || $estimate->freight_charge != '')
                    <tr>
                        <td>Freight</td>
                ...
                @if ($estimate->misc_charge != 0 || $estimate->freight_charge != '')
                    <tr>
                        <td>Mise</td>
                ...
                @if ($estimate->grand_total != 0 || $estimate->grand_total != '')
                    <tr>
                        <td>Grand Total</td>
                ...
                @if ($paid_in_cash != 0 || $paid_in_cash != '')
                    <tr>
                        <td>Paid In Cash</td>
                ...
                @if ($paid_in_bank != 0 || $paid_in_bank != '')
                    <tr>
                        <td>Paid In Bank</td>
                ...
                @if ($estimate->dues_amount != 0 || $estimate->dues_amount != '')
                    <tr>
                        <td>Due</td>
