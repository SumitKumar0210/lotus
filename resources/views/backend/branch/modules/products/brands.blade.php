    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('branch-brand.getBrandsList') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $(document).on('click', '.editProduct', function() {
                ...
                //get show route
                let url = "{{ route('branch-brand.show', ':update_id') }}";
            ...
            $(document).on('click', '.updateProductButton', function(e) {
                ...
                if (brand_name_edit === '') {
                    ...
                    //get update route
                    let url = "{{ route('branch-brand.update', ':update_id') }}";
                    url = url.replace(':update_id', update_id);
                    //get update route
                    ...
                    buttons: {
                        ok: {
                            action: function() {
                                ...
                                let url = "{{ route('branch-brand.destroy', ':delete_id') }}";
