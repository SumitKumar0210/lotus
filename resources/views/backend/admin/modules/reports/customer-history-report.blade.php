...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Customer History Report</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Report</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Customer History Report</li>
                </ol>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('reports.getCustomerHistoryReportList') }}',
                    data: function(d) {
