...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Product Report</h2>
                <ol class="breadcrumb">
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('branch.productReport.getProductReportList') }}',
                    data: function(d) {
            ...
            $('.livesearch').select2({
                ...
                width: '100%',
                ajax: {
                    url: '{{ route('branch.productReport.getBranchProductStockListSearch') }}',
                    dataType: 'json',
                    delay: 250,
            ...
            $(document).on('click', '.exportToExcel', function(e) {
                $("#product_table").table2excel({
                    exclude: ".noExl",
                    name: "productReport",
                    filename: "productReport-" + today + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
