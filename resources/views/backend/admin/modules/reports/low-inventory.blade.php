...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Low Inventory Report</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Report</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Low Inventory Report</li>
                </ol>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="product_id">Select Model</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('reports.getLowInventoryReportList') }}',
                    data: function(d) {
            ...
            $(document).on('click', '.exportToExcel', function(e) {
                $("#product_table").table2excel({
                    exclude: ".noExl",
                    name: "lowInventoryReport",
                    filename: "lowInventoryReport-" + today + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
