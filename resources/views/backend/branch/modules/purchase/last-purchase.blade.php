...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Last Purchases Branch</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Purchase</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Last Purchases Branch</li>
                </ol>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: '{{ route('branch.purchase.getBranchLastPurchaseList') }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
            ...
            $(document).on('click', '.exportToExcel1', function(e) {
                $("#product_table").table2excel({
                    exclude: ".noExl",
                    name: "branchLastPurchase",
                    filename: "branchLastPurchase-" + today + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
