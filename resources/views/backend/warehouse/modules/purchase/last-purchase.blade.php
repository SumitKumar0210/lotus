...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Last Purchases </h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Purchase</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Last Purchases </li>
                </ol>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            let table = $('#product_table').DataTable({
                ...
                ajax:
                    {
                        url: '{{ route("warehouse.purchase.getWarehouseLastPurchaseList") }}',
                    },
                columns: [
