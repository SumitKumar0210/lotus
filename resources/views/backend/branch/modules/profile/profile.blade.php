                            ...
                            <div class="col-sm-6 border-right">
                                <div class="description-block">
                                    @php
                                        ...
                                        $firstDay = $startDate->firstOfMonth()->format('yy-m-d h:i:s');
                                        $estimate = \App\Models\Estimate::where('payment_status','PAYMENT DONE')
                                    ...
                                    <h5 class="description-header mb-1">
                                        {{$estimate_payments_total}}
                                    </h5>
                                    <span class="text-muted">Sales of Month</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="description-block">
                                    @php
                                        $estimate = \App\Models\Estimate::where('payment_status','PAYMENT DUE')->where('user_id',Auth::id())->get();
