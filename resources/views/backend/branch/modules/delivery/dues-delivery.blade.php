...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Dues Delivery</h2>
                <ol class="breadcrumb">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6"> --}}
                        {{-- <div class="form-group"> --}}
                        {{-- <label for="product_name">Qty Left</label> --}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="size">Qty To Mark Deliver </label>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('branch.duesDeliveryList.getDuesDeliveryList') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $(document).on('click', '.createProductButton', function(e) {
                ...
                if (qty_to_mark_deliver === '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('dues-delivery-list.store') }}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
