        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('estimate.update', $estimate->id) }}"
                                        ...
                                        <div class="table-responsive mg-t-40">
                                            <table class="table table-invoice table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="valign-middle" colspan="2" rowspan="8">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tx-right" colspan="2"><input class="form-control"
                                                                ...
                                                                value="{{ $estimate->misc_charge }}" type="text"
                                                                readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="tx-right" colspan="2"><input class="form-control"
                                                                ...
                                                                value="{{ $estimate->grand_total }}" type="text"
                                                                readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tx-right" colspan="2"><input class="form-control"
                                                                ...
                                                                value="{{ $estimate->dues_amount }}" type="number"
                                                                readonly>
                                                        </td>
                                                    </tr>
                                                </tbody>
                        ...
                        $.each(data.success, function(key, value) {
                            ...
                            if (value.product_type == 'READY PRODUCT') {
                                ...
                                let html = '<tr id="acc' + initial_index_start_value_counter +
                                    ...
                                    '<td>' + value.color + '</td>' +
                                    '<td>' + value.size + '</td>' +
                                    '<td><input id="quantity_ready_product_table' + value
                                    .product_id + '" data-id="' + value.product_id +
                                    '" data-index="' + initial_index_start_value_counter +
                                    '" class="quantity_ready_product_table" type="number" min="1" minlength="1" value="' +
                                    value.qty + '"></td>' +
                                    //'<td id="maximum_retail_price_ready_product_table' + value.product_id + '">&#8377; ' + value.mrp + '</td>' +
