...
@section('content')
    <div class="container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{route('branch-transfer-warehouse.store')}}" method="POST" enctype="multipart/form-data"
              id="submit_form">
            @method('POST')
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <p class="h5">From:</p>
                            <div style="width:60%">
                                <input class="form-control" placeholder="Name" name="from_name" id="from_name"
                                       type="text" value="{{$warehouse_detail->branch_name}}"><br>
                                <input class="form-control" placeholder="Email" name="from_email" id="from_email"
                                       type="email" value="{{$warehouse_detail->email}}"><br>
                                <input class="form-control" placeholder="Mobile No" name="from_mobile" id="from_mobile"
                                       type="text" value="{{$warehouse_detail->phone}}"><br>
                                <textarea placeholder="Address" class="form-control" name="from_address"
                                          id="from_address" rows=""
                                          cols="">{{$warehouse_detail->address}}</textarea>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card custom-card overflow-hidden" style="margin-bottom: 100px;" >
                        <div class="card-body">
                        ...
                        <div class="text-center mb-5" >
                            <button class="btn ripple btn-primary submitButton" type="submit">Submit</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!--<select class="form-control" id="product_code_choose" name="product_code_choose"-->
                                <!--        required>-->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="" name="color" id="color"
                                       type="text" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="" id="size" name="size"
                                       type="text" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="product_stock_qty" name="product_stock_qty"
                                       type="number" minlength="1" value="" readonly>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('change', '#to_branch_id', function () {
                ...
                if (selected_value !== '') {
                    //get show route
                    let url = "{{route('branch-transfer-warehouse.show',':selected_value')}}";
                    ...
                    ({
                        ...
                        success: function (data) {
                            let html = '<div class="form-group">\n' +
                                '<input class="form-control" type="text" placeholder="Branch Name" name="to_name" value="' + data.branch_name + '" id="to_name" readonly>' +
                                '</div>\n' +
                                '<div class="form-group">\n' +
                                '<input class="form-control" type="text" placeholder="Email" name="to_email" value="' + data.email + '" id="to_email" readonly>\n' +
                                '</div>\n' +
                                '<div class="form-group">\n' +
                                '<input class="form-control" type="text" placeholder="Phone" name="to_phone" value="' + data.phone + '" id="to_phone" readonly>\n' +
                                '</div>\n' +
                                '<div class="form-group">\n' +
                                '<input class="form-control" type="text" placeholder="Address"  name="to_address" value="' + data.address + '"  id="to_address" readonly>\n' +
                                '</div>';
        ...
        $('.livesearch').select2({
            ...
            $(document).on('change', '#product_code_choose', function () {
                ...
                if (product_code_choose !== '') {
                    ...
                    let url = "{{route('warehouse.branchTransfer.getBranchTransferProductDetail',':product_code_choose')}}";
                ...
                if (product_id === '') {
                    ...
                    if (checkAccessory === true) {
                        ...
                        let html = '<tr id="acc' + initial_index_start_value_counter + '">' +
                            ...
                            '<td>' + color + '</td>' +
                            '<td>' + size + '</td>' +
                            '<td><input data-id="' + product_id + '" data-index="' + initial_index_start_value_counter + '" class="quantity_table" type="number" min="1" minlength="1" value="' + qty + '" readonly></td>' +
                            '<td><a href="javascript:void(0)" data-index="' + initial_index_start_value_counter + '"  data-product_id ="' + product_id + '"  class="btn-danger btn-sm removeProductButton"><i class="fa fa-trash"></i></a></td>' +
                            '</tr>';
            ...
            $(document).on('change keyup keydown', '.quantity_table', function (e) {
                ...
                if (parseInt(this_value) > parseInt(product_stock_qty)) {
            ...
            $(document).on('submit', '#submit_form', function (e) {
                ...
                if (from_name === '') {
                    ...
                    ({
                        type: "POST",
                        url: "{{route('branch-transfer-warehouse.store')}}",
