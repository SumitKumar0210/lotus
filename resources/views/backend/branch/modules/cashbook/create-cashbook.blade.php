...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('branch.cashbook.cashbookList')}}">Cashbook</a></li>
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 ">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h5 class=" card-title mb-1">Transfer Cash To HO</h5>
                    </div>
                    <hr>
                    <div class="row">
...
<script>
    ...
    function addCashbook()
    {
        ...
        if(amount < 1)
        {
            alertErrorMessage('Enter No Of Notes');
        }
        else{
            $.ajax({
                url: "{{route('branch.cashbook.store')}}",
                method:"POST",
                data:{amount:amount,currency:currency,no_of_note:no_of_note,total:total},
                cache: false,
                dataType: "json",
