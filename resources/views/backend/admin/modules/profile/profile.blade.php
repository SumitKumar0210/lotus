                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="card custom-card">
                                            ...
                                            <form method="POST" action="{{route('user-password.update')}}"
                                                ...
                                                <div class="form-group">
                                                    <input id="password" class="form-control @error('password', 'updatePassword') is-invalid @enderror" name="password"
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control @error('password_confirmation', 'updatePassword') is-invalid @enderror" id="password_confirmation" name="password_confirmation"
