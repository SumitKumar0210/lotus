...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Cancelled Estimate List</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Estimate</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Cancelled Estimate List</li>
                </ol>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.deleteProduct', function () {
                ...
                $.confirm({
                    title: "{{__('Hello!')}}",
                    content: "{{__('Are you sure to remove this delete Estimate?')}}",
                    ...
                    buttons: {
                        ok: {
                            action: function () {
                                ...
                                let url = "{{route('estimate-list-cancelled.destroy',':delete_id')}}";
