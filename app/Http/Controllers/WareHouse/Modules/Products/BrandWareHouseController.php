...
class BrandWareHouseController extends Controller
{

    public function getWarehouseBrandsList(Request $request)
    {
        if ($request->ajax()) {
            $data = Brand::get();
    ...
    {
        return view('backend.warehouse.modules.products.brands');
    }
