    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('branch-product.getProductList') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            @include('backend.branch.messages.message-jquery-confirm-function')
            ...
            $(document).on('click', '.editProduct', function() {
                ...
                //get show route
                let url = "{{ route('branch-product.show', ':update_id') }}";
            ...
            $(document).on('click', '.updateProductButton', function(e) {
                ...
                if (product_name === '') {
                    ...
                    //get update route
                    let url = "{{ route('branch-product.update', ':update_id') }}";
                    url = url.replace(':update_id', update_id);
                    //get update route
                    ...
                    buttons: {
                        ok: {
                            action: function() {
                                ...
                                let url =
                                    "{{ route('branch-product.destroy', ':delete_id') }}";
                    ...
                    buttons: {
                        ok: {
                            action: function() {
                                ...
                                let url =
                                    "{{ route('branch.product.productStatusChange', ':update_id') }}";
                                url = url.replace(':update_id', update_id);
