...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Receive Cash</a></li>
...
<script>
    ...
    {
        let url = "{{route('branch.cashbook.receiveCashData',':slip')}}";
    ...
    function approveCash()
    {
        ...
        $.ajax({
            url: "{{ route('branch.cashbook.approveReceiveCash') }}",
            method:"POST",
            data:{id:id},
            cache: false,
            dataType: "json",
    ...
    function declineReceiveCash()
    {
        ...
        $.ajax({
            url: "{{ route('branch.cashbook.declineReceiveCash') }}",
            method:"POST",
