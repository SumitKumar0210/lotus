...
<head>
    <title>@yield('title','WAREHOUSE ADMIN')</title>
...
<!-- Page -->
<div class="page">
@include('backend.warehouse.includes.sidebar')
<!-- Main Content-->
    <div class="main-content side-content pt-0">
        @include('backend.warehouse.includes.header')
        @yield('content')
    </div>
    <!-- End Main Content-->
    @include('backend.warehouse.includes.footer')
</div>
<!-- End Page -->
<!-- Back-to-top -->
