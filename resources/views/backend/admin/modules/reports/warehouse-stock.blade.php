...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">WareHouse Report</h2>
                <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="livesearch form-control" name="product_id" id="product_id"
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('reports.getWarehouseReportList') }}',
                    data: function(d) {
            ...
            $('.livesearch').select2({
                ...
                width: '100%',
                ajax: {
                    url: '{{ route('branch.branchStock.getBranchStockListSearchAdmin') }}',
                    dataType: 'json',
                    delay: 250,
            ...
            $(document).on('click', '.exportToExcel', function(e) {
                $("#product_table").table2excel({
                    ...
                    filename: "warehouseReport-" + today + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
