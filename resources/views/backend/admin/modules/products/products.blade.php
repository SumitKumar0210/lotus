                            ...
                            <table class="table" id="product_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-20p">Remaining Qty</th>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="maximum_retail_price_edit" name="maximum_retail_price_edit"
                                type="text" value="1">
                        </div>
                    </div>
                    <div class="col-md-12">
...
<script>
    $(document).ready(function() {
            ...
            //     processing: true,
            //     serverSide: true,
            //     ajax: "{{ route('product.getProductList') }}",
            //     columns: [{
            //             data: 'checkbox',
            //             name: 'checkbox',
            //             orderable: false,
            ...
            $(document).on('click', '#btn_submit', function(e) {
                ...
                $.confirm({
                    title: "Hello!",
                    content: "Are you sure to delete bulk products?",
                    ...
                    buttons: {
                        ok: {
                            action: function() {
                                ...
                                formData.append('products_id', checked_value);
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('admin.products.deleteBulkProducts') }}",
                                    data: formData,
                                    cache: false,
                                    contentType: false,
                                    processData: false,
                    ...
                    buttons: {
                        ok: {
                            action: function() {
                                ...
                                let url =
                                    "{{ route('product.productStatusChange', ':update_id') }}";
                                url = url.replace(':update_id', update_id);
