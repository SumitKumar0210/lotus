...
<div class="container-fluid">
    ...
    @php
    $branch_id = $branch_id;
    $calc_date = date('Y-m-d',strtotime($firstDay));
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
							...
							@if($item->paid_in_upi > 0)
								@php
                            $total_other_amount +=$item->paid_in_upi;
                            @endphp
                            <tr>
                                <td>{{$estimate_no}}/{{$customer}}</td>
                                <td>UPI</td>
                                <td></td>
                                <td>{{$item->paid_in_upi}}</td>
                            </tr>
							@endif
                            @if($item->paid_in_neft > 0)
                            @php
                            ...
                            <tr>
							 ...
							 @endif
                            @if($item->paid_in_cheque > 0 && $item->status == 'Approved')
                            @php
