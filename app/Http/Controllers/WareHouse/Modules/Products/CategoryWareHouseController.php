...
namespace App\Http\Controllers\WareHouse\Modules\Products;
...
class CategoryWareHouseController extends Controller
{
    public function getWarehouseCategoryList(Request $request)
    {
        if ($request->ajax()) {
            $data = Category::get();
    ...
    {
        return view('backend.warehouse.modules.products.categories');
    }
