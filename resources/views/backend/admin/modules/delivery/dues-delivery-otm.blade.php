    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('branch.getDuesDeliveryListOTMAdmin.getDuesDeliveryListOTMAdmin') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $(document).on('click', '.createProductButton', function(e) {
                ...
                if (qty_to_mark_deliver === '') {
                    ...
                    formData.append('product_mark_delivered_qty', qty_to_mark_deliver);
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('dues-delivery-list-otm-admin.store') }}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
