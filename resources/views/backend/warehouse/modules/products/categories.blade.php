                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="form-group">
                                <label for="brand_name">Category Name </label>
                                <input class="form-control" placeholder="" id="category_name_edit"
                                    name="category_name_edit" type="text">
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#product_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('warehouse-category.getWarehouseCategoryList') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $(document).on('click', '.createProductButton', function(e) {
                ...
                if (category_name === '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('warehouse-category.store') }}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
            ...
            $(document).on('click', '.editProduct', function() {
                ...
                //get show route
                let url = "{{ route('warehouse-category.show', ':update_id') }}";
            ...
            $(document).on('click', '.updateProductButton', function(e) {
                ...
                if (category_name_edit === '') {
                    ...
                    //get update route
                    let url = "{{ route('warehouse-category.update', ':update_id') }}";
                    url = url.replace(':update_id', update_id);
                    //get update route
                    ...
                    buttons: {
                        ok: {
                            action: function() {
                                ...
                                let url =
                                    "{{ route('warehouse-category.destroy', ':delete_id') }}";
