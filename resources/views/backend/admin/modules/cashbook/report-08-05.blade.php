                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $total_opening = 0;
                            $estimate_payments =
                            \App\Models\EstimatePaymentList::whereBetween('created_at',[$date_from,$date_to])->get();
                            @endphp
                            ...
                            @endphp
                            <tr>
                                <td>{{$item->id}}/{{$estimate_no}}/{{$customer}}</td>
                                <td>Cash</td>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $total_expenses = 0;
                            $expenses =
                            \App\Models\Expense::where('mode','CASH')->whereBetween('created_at',[$date_from,$date_to])->where('branch_id',$branch_id)->get();
                            @endphp
                            @if(!empty($expenses))
