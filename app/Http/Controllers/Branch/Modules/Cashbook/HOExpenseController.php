...
class HOExpenseController extends Controller
{
    public function expense()
    {
        $expenses = Expense::get();
        return view('backend.branch.modules.cashbookHO.expense', compact('expenses'));
    }
    ...
    public function addExpense(Request $request)
    {
        if ($request->ajax()) {
            ...
            $expenses->datetime = date('Y-m-d', strtotime($request->date));
    ...
    public function editExpense($id)
    {
        ...
        $data = [
            'datetime' => date('Y-m-d', strtotime($expenses->datetime)),
            'id' => $expenses->id,
