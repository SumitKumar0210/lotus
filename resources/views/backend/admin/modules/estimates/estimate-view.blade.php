...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">View Estimate</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Estimate</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View Estimate</li>
                </ol>
            </div>

            <div class="btn btn-list">
                <a class="btn ripple btn-primary" href="{{ route('estimate.index') }}"><i class="fe fe-external-link"></i>
                    Go Back</a>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 text-left">
                                <p class="h6">BRANCH DETAILS:</p>
                                <address>
                                    Branch Name: {{ $estimate->user->branch->branch_name }}<br>
                                    Branch Email: {{ $estimate->user->branch->email }}<br>
                                    Branch Phone: {{ $estimate->user->branch->phone }}<br>
                                    Branch Address: {{ $estimate->user->branch->address }}<br>
                                </address>
                            </div>
                        </div>
