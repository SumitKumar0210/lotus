...
<head>
    <title>@yield('title','BRANCH ADMIN')</title>
...
<!-- Page -->
<div class="page">
@include('backend.branch.includes.sidebar')
<!-- Main Content-->
    <div class="main-content side-content pt-0">
        @include('backend.branch.includes.header')
        @yield('content')
    </div>
    <!-- End Main Content-->
    @include('backend.branch.includes.footer')
</div>
<!-- End Page -->
<!-- Back-to-top -->
