...
class BranchReportController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        $expenses = Expense::where('status', 'Approved')->whereBetween('datetime', [$date_from, $date_to])->get();
        ...
        while ($date_from <= $date_to) {
            ...
            $expenses = Expense::where('status', 'Approved')->whereBetween('datetime', [$date1, $date2])->get();
