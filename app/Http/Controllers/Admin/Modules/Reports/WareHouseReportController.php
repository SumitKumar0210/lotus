...
class WareHouseReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.admin.modules.reports.warehouse-stock', compact('products'));
    }


    public function getWarehouseReportList(Request $request)
    {
        if ($request->ajax()) {
            ...
            if (!empty($_GET["date_from"]) && !empty($_GET["date_to"]) && !empty($_GET["product_id"])) {
                ...
                $usersQuery->where('type', 'WAREHOUSE STOCK')
    ...
    public function getBranchStockListSearchAdmin(Request $request)
    {
//        $stocks = [];
//        if ($request->has('q')) {
//            $search = $request->q;
